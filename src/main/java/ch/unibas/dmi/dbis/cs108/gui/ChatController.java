...
/**
 * The {@link  ChatController} class acts as the controller for the chat GUI. It is responsible for
 * handling user input, sending messages via the {@link ProtocolWriterClient}, and updating the chat
 * display area with incoming messages. The corresponding FXML file is expected to define a
 * {@link TitledPane} containing a {@link TextArea} for displaying chat messages and a
 * {@link TextField} for user input to write a message.
 *
 * @author julia
 */
