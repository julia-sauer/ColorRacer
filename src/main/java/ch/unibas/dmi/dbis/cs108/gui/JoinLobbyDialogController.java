...
/**
 * This is the controller class for handling the "Join" lobby dialog window.
 * This controller allows users to view a list of available lobbies,
 * select one to join, or cancel the dialog.
 *
 * @author julia
 */
public class JoinLobbyDialogController {
    ...
    /**
     * Handles the "Join" action {@link Button}.
     * Retrieves the selected lobby from the list and closes the dialog.
     */
    @FXML
    ...
    /**
     * Handles the "Cancel" action {@link Button}.
     * Clears any selected lobby and closes the dialog.
     */
    @FXML
