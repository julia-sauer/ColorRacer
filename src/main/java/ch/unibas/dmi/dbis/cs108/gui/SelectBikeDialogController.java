...
/**
 * This is the controller class for the "Select Bike" dialog.
 * This dialog allows the user to choose a bike color before the game starts.
 * When a color is selected, the dialog closes and the selected color
 * can be retrieved via {@link #getSelectedBike()}.
 *
 * @author julia
 */
public class SelectBikeDialogController {
    ...
    /**
     * Handles the bike selection by determining which {@link Button} was clicked.
     * Sets the selected bike color accordingly and closes the dialog.
     *
