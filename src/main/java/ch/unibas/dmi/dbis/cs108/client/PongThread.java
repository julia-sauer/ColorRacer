...
/**
 * A class that listens for PING messages from the server and sends PONG responses. This class
 * should be used in a separate thread to maintain the connection.
 *
 * @deprecated
 */
class PongThread implements Runnable {
  ...
  /**
   * Listens for PING messages from the server and sends PONG responses. This method runs in a loop
   * and continuously reads messages from the InputStream.
   */
  public void run() {
    try {
